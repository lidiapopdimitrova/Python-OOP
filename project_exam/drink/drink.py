...
class Drink(ABC):
    ...
    def portion(self, value):
        Validator.raise_number_is_zero_or_below(value, "Portion cannot be less than or equal to zero!" )
    ...
    def brand(self, value):
        Validator.raise_if_string_is_empty_or_spaces(value, "Brand cannot be empty string or white space!")
        self.__brand = value
