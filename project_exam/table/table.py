...
from project_exam.baked_food.baked_food import BakedFood
...
class Table(ABC):
    ...
    def table_number(self, value):
        Validator.raise_if_number_not_in_range(
            ...
            self.error_message_table_number)
    ...
    def capacity(self, value):
        Validator.raise_number_is_zero_or_below(value, "Capacity has to be greater than 0!")
