from project_exam.core.food_factory import FoodFactory
...
class Bakery:
    ...
    def order_drink(self, table_number: int, *drink_names):
        ...
        for drink_name in drink_names:
            ...
            if drink is None:
                skipped_drinks += f"{drink_name}\n"
            else:
                ordered_drinks += str(drink_name) + "\n"
    ...
    def get_free_tables_info(self):
        ...
        for table in self.tables_repository:
            if not table.is_reserved:
                free_tables_result += table.free_table_info() + "\n"

        return free_tables_result.strip()
